...
const ProjectCard = () => {
  return (
    <div className='h-[320px] max-w-[380px] min-w-[240px] border-[1px] my-5.5 px-3 py-2 m-2 sm:m-2 md:mx-3 border-neutral-300 block justify-center rounded-xl hover:scale-100 hover:shadow-lg duration-700 dark:bg-gray-800 dark:border-zinc-700 dark:shadow-gray-600'>

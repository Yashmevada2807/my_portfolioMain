            ...
            <div className="main w-full  border-zinc-500 justify-center items-center sm:flex flex-col sm:flex-row py-2  h-auto">
                <div className="info  md:w-[50%] h-auto flex flex-col justify-center items-center text-center px-5 md:px-8  py-6 md:py-10 ">
                    ...
                    <div className="flex flex-col sm:flex-row text-center w-full sm:w-auto gap-8 pt-5 ">
                        ...
                        <Link className=' bg-gray-400 rounded-md flex items-center justify-center shadow-2xs font-mono text-center px-4 py-2 sm:w-auto hover:text-white hover:scale-105 sm:hover:scale-110 hover:bg-gray-600 border-2 duration-300 hover:border-blue-600 dark:bg-gray-700 ' to='/myprojects'>See all projects</Link>

                    </div>
                </div>
                <div className="img md:w-[50%] p-8 h-auto flex justify-center">
                    <Link className="w-fit h-auto rounded-br-2xl rounded-tl-2xl hover:rounded-br-4xl hover:rounded-tl-4xl overflow-hidden cursor-pointer hover:shadow-2xl shadow-amber-200/100 hover:scale-[105%] duration-1000 dark:hover:shadow-lg" to="/AboutMe">
                        <img className=" w-full h-auto max-w-xs sm:max-w-sm md:max-w-md" src="\MyPicForGitHubProfile.jpg" alt="" />
                    </Link>
                </div>
            </div>
            <div className=" flex border-b-[1px] border-t-[1px] border-neutral-300 justify-center dark:border-zinc-600 items-center font-bold text-2xl p-2">

        ...
        <div className=" w-full overflow-hidden overflow-y-scroll">
            <div className="main w-full justify-center items-center sm:flex flex-col sm:flex-row py-2 border h-auto">
                <div className="info  md:w-[50%] h-auto flex flex-col justify-center items-center text-center px-5 md:px-8  py-6 md:py-10 ">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-8 pt-5 ">

                        <Link className=' bg-gray-400 rounded-md flex items-center justify-center shadow-2xs font-mono text-center px-4 py-2 sm:w-auto hover:text-white  hover:scale-110 hover:bg-gray-600  duration-300' to='/MyProject'>Button1</Link>
                        <Link className='  bg-gray-400 rounded-md flex items-center justify-center shadow-2xs font-mono text-center px-4 py-2 sm:w-auto hover:text-white  hover:scale-110 hover:bg-gray-600  duration-300' to='/AboutMe'>Button2</Link>
